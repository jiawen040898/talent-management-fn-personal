...
const lambdaName = 'talent-management-process-employee-fit-score-fn';

export class ProcessEmployeeFitScoreFnResource extends Construct {
    /**
     * ProcessEmployeeFitScoreFnResource
     *
