...
const sqsName = 'talent-management-lxp-manager-subordinate-progress-report';
const snsTopicArn = `arn:aws:sns:${region}:${accountId}:identity-company-cron-topic`;

export class TalentManagementLxpManagerSubordinateProgressReportQueueResource extends Construct {
        ...
        sns.addSubscription(
            new SqsSubscription(sqs.mainSqs, {
                filterPolicy: {
                    ...
                    local_weekday: SubscriptionFilter.numericFilter({
                        allowlist: [1],
                    }),
                },
            }),
