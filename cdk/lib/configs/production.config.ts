...
export const config = (scope: Construct): CDKEnvironmentVariables => ({
    ...
    GCP_CLIENT_LIBRARY_CONFIG: JSON.stringify({
        ...
        audience:
            '//iam.googleapis.com/projects/996225698922/locations/global/workloadIdentityPools/aws-production/providers/pulsifi-aws-production',
        subject_token_type: 'urn:ietf:params:aws:token-type:aws4_request',
        service_account_impersonation_url:
            'https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/talent-management-fn@data-production-warehouse.iam.gserviceaccount.com:generateAccessToken',
